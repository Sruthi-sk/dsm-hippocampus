"""
DELETE
Dataset with states as place cells of the agent (from TaskEnv in RatInABox-v0) - 1 goal now in centre, 10 place cells
- actor critic
...
def main(
    ...
    *,
    ...
    if env_id == "Ratinabox-v0-pc-random":
    ...
    joblib.dump(placecells.params, folder_dataset_path+'/placecells_params_latest_run.pkl')
