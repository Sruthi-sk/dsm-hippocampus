# ~ INSTRUCTIONS: To be placed in the ratinabox.contribs folder ~
# ======================================
...
class TaskEnvironmentGym(Environment, pettingzoo.ParallelEnv):
    """
    ...
    **kws :
    ...
    metadata = {"render_modes": ["matplotlib", "none"], "name": "TaskEnvironmentGym-RiaB"}
    ...
    def __init__(
        ...
        **kws,
        ...
        self.observation_space = Box(low=lows, high=highs, dtype=np.float_)
    ...
    def debug_observation_space(self):
        print('debug obs space: ',self.observation_space )
        print('debug self.extent: ',self.extent)
    ...
    def _render_mpl_agents(self, framerate=60, alpha=0.7, t_start="episode", **kws):
        ...
        **kws
        ...
        def get_agent_props(agent, color):
            ...
            skiprate=1
            # print('debug skiprate', skiprate,framerate,agent.dt)
...
class Goal:
    ...
    def __init__(
        self,
        env: Union[None, TaskEnvironmentGym] = None,
...
class SpatialGoalEnvironment(TaskEnvironmentGym):
    """
    ...
    ----------
    *pos :
        Positional arguments for TaskEnvironmentGym
            - n_agents : int
            -
